...
\ifdefined\ScrollEdition
  % Scroll edition: embedded PDF pages carry no scroll position marks, so
  % the height-measuring pass cannot size them. Point at the letter edition.
  \begin{quotation}
  \textit{The report pages are embedded in the paginated letter edition of
  this manual (\texttt{care-commons-ehr-software-manual.pdf}); in this
  scroll edition, please consult the archived PDFs directly.}
  \end{quotation}
\else
