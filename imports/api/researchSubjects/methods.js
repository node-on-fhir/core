...
import { ResearchSubjects, ResearchSubjectSchema } from '/imports/lib/schemas/SimpleSchemas/ResearchSubjects';
...
export const createResearchSubject = new ValidatedMethod({
  ...
  async run({ researchSubject }) {
    ...
    try {
      ...
      const cleanedData = ResearchSubjectSchema.clean(researchSubject);
      ResearchSubjectSchema.validate(cleanedData);
