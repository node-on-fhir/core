...
Session.setDefault('healthcareServicePageTabIndex', 1);
...
export function HealthcareServicesPage(props){
  ...
  const isLoading = useTracker(() => {
    ...
    if(autoSubscribeEnabled){
      ...
      const handle = Meteor.subscribe('selectedPatient.HealthcareServices', Session.get('selectedPatientId'), { limit: 100 });
      return !handle.ready();
    }
  }, [searchFilter]);
  ...
  function handleAddHealthcareService(){
    console.log('Add HealthcareService button clicked');
      ...
      <Box mb={2}>
            ...
            <Box display="flex" gap={2} alignItems="center">
              ...
              <ToggleButtonGroup
                ...
                onChange={(event, newFormats) => {
                  setShowLocation(newFormats.includes('location'));
                  setShowSystemId(newFormats.includes('systemId'));
                }}
                aria-label="display options"
                size="small"
              >
                <ToggleButton value="location" aria-label="show location column">
                  <LocationOnIcon />
                </ToggleButton>
        ...
        <Box mt={2}>
          <TextField
            ...
            fullWidth
            placeholder="Search healthcare services by ID, name, type, or category..."
            value={searchFilter}
