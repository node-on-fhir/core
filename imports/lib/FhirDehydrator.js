...
export function flattenServiceRequest(document){
  let result = {
    ...
    description: get(document, 'code.text', get(document, 'code.coding[0].display', '')),
    text: get(document, 'text.div', ''),
    category: get(document, 'category[0].coding[0].code', ''),
    categoryDisplay: get(document, 'category[0].coding[0].display', ''),
    bodySite: get(document, 'bodySite[0].text', get(document, 'bodySite[0].coding[0].display', '')),
    reasonCode: get(document, 'reasonCode[0].text', get(document, 'reasonCode[0].coding[0].display', '')),
    note: get(document, 'note[0].text', ''),
    encounterReference: get(document, 'encounter.reference', ''),
    modality: get(document, 'orderDetail[0].text', get(document, 'code.coding[0].code', '')),
    barcode: get(document, '_id', ''),
  };
