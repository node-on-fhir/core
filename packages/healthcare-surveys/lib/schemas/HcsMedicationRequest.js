...
HcsMedicationRequestSchema = new SimpleSchema([
...
// Create collection
HcsMedicationRequest = new Mongo.Collection('HcsMedicationRequest');
HcsMedicationRequest.attachSchema(HcsMedicationRequestSchema);

// Export
if (typeof exports === 'object') {
  module.exports = { HcsMedicationRequest, HcsMedicationRequestSchema };
}