...
HcsCompositionSchema = new SimpleSchema([
...
// Create collection
HcsComposition = new Mongo.Collection('HcsComposition');
HcsComposition.attachSchema(HcsCompositionSchema);

// Export
if (typeof exports === 'object') {
  module.exports = { HcsComposition, HcsCompositionSchema, HCS_COMPOSITION_SECTIONS };
}