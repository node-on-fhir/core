...
HcsMedicationStatementSchema = new SimpleSchema([
...
// Create collection
HcsMedicationStatement = new Mongo.Collection('HcsMedicationStatement');
HcsMedicationStatement.attachSchema(HcsMedicationStatementSchema);

// Export
if (typeof exports === 'object') {
  module.exports = { HcsMedicationStatement, HcsMedicationStatementSchema };
}