...
// NASA MEDB (Medical Evaluation Documents) Questionnaires
// Generated from data/NASA.Questionnaires.ndjson
// Includes full FHIR Questionnaire objects for form rendering
...
export const nasaQuestionnaires = [
  ...
  },
  {
    ...
    "questionnaire": {
      ...
      "contact": [
        {
          "name": "Environmental Health System"
        }
      ],
      "jurisdiction": [
        {
  ...
  },
  {
    ...
    "description": "NASA Medical Requirements Integration Document for radiation monitoring and crew personal dosimetry. Captures crew radiation exposure data for occupational exposure documentation and health risk asses",
    "category": "NASA",
    "questions": 60,
    ...
    "questionnaire": {
      ...
      "contact": [
        {
          "name": "Space Radiation Analysis Group"
        }
      ],
      "jurisdiction": [
        {
  ...
  },
  {
    ...
    "description": "NASA Medical Requirements Integration Document for preflight behavioral health assessment. Captures psychiatric/psychological assessment of behavioral readiness for flight and review of psychological ",
    "category": "NASA",
    "questions": 43,
    ...
    "questionnaire": {
      ...
      "contact": [
        {
          "name": "Behavioral Health and Performance"
        }
      ],
      "jurisdiction": [
        {
