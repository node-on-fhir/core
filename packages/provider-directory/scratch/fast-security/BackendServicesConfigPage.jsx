...
function BackendServicesConfigPage(props){
  ...
  function openExternalPage(url){
    logger.debug('client.app.layout.BackendServicesConfigPage.openExternalPage', url);
    window.open(url);
  ...
  return (
    <PageCanvas id='BackendServicesConfigPage' headerHeight={headerHeight} paddingLeft={10} paddingRight={10}>

      <Container maxWidth="xl" style={{paddingBottom: '80px'}}>
      <CardHeader title="Backend Services Configuration"/>
        <Grid container spacing={3} justify="center" style={{marginBottom: '20px'}}>
          <Grid item xs={4} sm={4}>
            <StyledCard margin={20} style={{width: '100%'}}  >
              <CardHeader title="Fetch Wellknown Smart Metadata"/>
              <CardContent>
                <TextField
          ...
          <Grid item xs={4} sm={4}>
            ...
            <StyledCard margin={20} style={{width: '100%'}}  >
              <form onSubmit={formik.handleSubmit} style={{width: '100%'}}>
                <CardHeader title="Create JSON Web Token"/>
                <CardContent>
...
export default BackendServicesConfigPage;