...
HcsPlanDefinitionSchema = new SimpleSchema([
...
// Create collection
HcsPlanDefinition = new Mongo.Collection('HcsPlanDefinition');
HcsPlanDefinition.attachSchema(HcsPlanDefinitionSchema);

// Export
if (typeof exports === 'object') {
  module.exports = { HcsPlanDefinition, HcsPlanDefinitionSchema, HCS_PLANDEFINITION_ACTION_CODES };
}