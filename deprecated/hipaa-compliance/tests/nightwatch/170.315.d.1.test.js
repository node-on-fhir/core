...
module.exports = {
  ...
  'HIPAA Compliance - 170.315(d)(1) - Authentication, Access Control, Authorization': function (browser) {
    ...
    browser.perform(function() {
      if (!routeAvailable) {
        console.log('⏭️  /hipaa/audit-log route not available — hipaa-compliance package not loaded in this build. Skipping.');
        return;
      }
      ...
      // Log success
      browser.perform(function() {
        console.log('✅ ONC 170.315(d)(1) - HIPAA Compliance route accessibility test passed');
      });
    });
