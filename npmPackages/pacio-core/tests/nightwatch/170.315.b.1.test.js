...
module.exports = {
  ...
  'PACIO Core - 170.315(b)(1) - Transitions of Care': function (browser) {
    ...
    browser.execute(function() {
      ...
      if (!result.value.isLoggedIn) {
        browser.executeAsync(function(done) {
          ...
          console.log('✅ Test user logged in for ONC 170.315(b)(1)');
        });
      }
    });
    ...
    browser
      .saveScreenshot('tests/screenshots/pacio-core_170.315.b.1.png')
      .perform(function() {
        console.log('📸 Screenshot saved for ONC 170.315(b)(1)');
      })
      .end();
  }
};