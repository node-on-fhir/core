 ...
 */
const SmartMessagingServer = globalThis.SmartMessagingServer = {
  /**
...
const MessagingContexts = globalThis.MessagingContexts = new Mongo.Collection('smartWebMessagingContexts');
