...
test('tolerates empty and malformed input', function() {
  assert.deepEqual(resolveBundleReferences(null), { resources: [], resolvedCount: 0 });
  assert.deepEqual(resolveBundleReferences({}), { resources: [], resolvedCount: 0 });
  assert.deepEqual(resolveBundleReferences({ resourceType: 'Bundle', entry: [{}] }), { resources: [], resolvedCount: 0 });
});
