...
// (was a bare implicit-global assignment under Atmosphere api.export; declared
// with const for ES-module strict mode under Rspack/swc)
const HipaaAuditLog = new Mongo.Collection('HipaaAuditLog');
...
// (HipaaAuditLogHelpers is already `export const` above — not re-exported here
// to avoid a duplicate-export parse error under swc/Rspack)
