...
module.exports = {
  ...
  'Family Health History - 170.315(a)(12) - Family Health History': function (browser) {
    ...
    browser.execute(function() {
      ...
      if (!result.value || !result.value.isLoggedIn) {
        browser.executeAsync(function(done) {
          ...
          console.log('✅ Test user logged in for ONC 170.315(a)(12)');
        });
      }
    });
    ...
    browser.perform(function() {
      if (!routeAvailable) {
        console.log('⏭️  /family-health-history route not available — family-health-history package not loaded in this build. Skipping.');
        return;
      }
