...
module.exports = {
  ...
  'Quality Measures - 170.315(g)(2) - Automated Denominator Recording': function (browser) {
    ...
    browser.execute(function() {
      ...
      if (!result.value.isLoggedIn) {
        browser.executeAsync(function(done) {
          ...
          console.log('✅ Test user logged in for ONC 170.315(g)(2)');
        });
      }
    });
    ...
    browser
      .saveScreenshot('tests/screenshots/quality-measures_170.315.g.2.png')
      .perform(function() {
        console.log('📸 Screenshot saved for ONC 170.315(g)(2)');
      })
      .end();
  }
};