...
const HcsServiceRequestSchema = globalThis.HcsServiceRequestSchema = new SimpleSchema([
...
// Create collection
const HcsServiceRequest = globalThis.HcsServiceRequest = new Mongo.Collection('HcsServiceRequest');
HcsServiceRequest.attachSchema(HcsServiceRequestSchema);

// Export
export { HcsServiceRequest, HcsServiceRequestSchema };