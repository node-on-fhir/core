...
const HealthcareSurveysReportingBundleSchema = globalThis.HealthcareSurveysReportingBundleSchema = new SimpleSchema([
  BundleSchema,
  {
...
// Create collection
const HealthcareSurveysReportingBundle = globalThis.HealthcareSurveysReportingBundle = new Mongo.Collection('HealthcareSurveysReportingBundle');
HealthcareSurveysReportingBundle.attachSchema(HealthcareSurveysReportingBundleSchema);

// Export
export { HealthcareSurveysReportingBundle, HealthcareSurveysReportingBundleSchema };