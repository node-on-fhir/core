...
const HcsDiagnosticReportSchema = globalThis.HcsDiagnosticReportSchema = new SimpleSchema([
...
// Create collection
const HcsDiagnosticReport = globalThis.HcsDiagnosticReport = new Mongo.Collection('HcsDiagnosticReport');
HcsDiagnosticReport.attachSchema(HcsDiagnosticReportSchema);

// Export
export { HcsDiagnosticReport, HcsDiagnosticReportSchema };