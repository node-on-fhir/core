...
const HcsMedicationAdministrationSchema = globalThis.HcsMedicationAdministrationSchema = new SimpleSchema([
...
// Create collection
const HcsMedicationAdministration = globalThis.HcsMedicationAdministration = new Mongo.Collection('HcsMedicationAdministration');
HcsMedicationAdministration.attachSchema(HcsMedicationAdministrationSchema);

// Export
export { HcsMedicationAdministration, HcsMedicationAdministrationSchema };