...
const HealthcareSurveysContentBundleSchema = globalThis.HealthcareSurveysContentBundleSchema = new SimpleSchema([
  BundleSchema,
  {
...
// Create collection
const HealthcareSurveysContentBundle = globalThis.HealthcareSurveysContentBundle = new Mongo.Collection('HealthcareSurveysContentBundle');
HealthcareSurveysContentBundle.attachSchema(HealthcareSurveysContentBundleSchema);

// Export
export { HealthcareSurveysContentBundle, HealthcareSurveysContentBundleSchema };