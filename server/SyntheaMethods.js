// /Volumes/SonicMagic/Code/honeycomb-public-release/server/SyntheaMethods.js
...
Meteor.methods({
  async generateResearchStudies(count = 5) {
    console.log('[SyntheaMethods] Generating Research Studies...', count);
    ...
    for (let i = 0; i < count; i++) {
      ...
      console.log(`[SyntheaMethods] Created Research Study: ${study.title}`);
    }
  ...
  async generateResearchSubjects(count = 10) {
    console.log('[SyntheaMethods] Generating Research Subjects...', count);
  ...
  async clearResearchData() {
    console.log('[SyntheaMethods] Clearing Research Data...');
